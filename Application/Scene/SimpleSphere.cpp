...
DEFINE_META_OBJECT(CSimpleSphere)
{
    BindPositionalArgument(&CSimpleSphere::Radius, 1, 0);
    BindPositionalArgument(&CSimpleSphere::ThetaSegs, 1, 1);
    BindPositionalArgument(&CSimpleSphere::PhiSegs, 1, 2);
}

void CSimpleSphere::UpdateEntity()
{
    if (!IsDirty())
        return;
